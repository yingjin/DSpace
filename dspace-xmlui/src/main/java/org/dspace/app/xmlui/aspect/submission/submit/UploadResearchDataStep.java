 ...
 */
public class UploadResearchDataStep extends AbstractSubmissionStep
{
    /** Language Strings for Uploading **/
    protected static final Message T_head =
            message("xmlui.Submission.submit.UploadResearchDataStep.head");
    protected static final Message T_file =
            message("xmlui.Submission.submit.UploadResearchDataStep.file");
    protected static final Message T_file_help =
            message("xmlui.Submission.submit.UploadResearchDataStep.file_help");
    protected static final Message T_file_error =
            message("xmlui.Submission.submit.UploadResearchDataStep.file_error");
    protected static final Message T_upload_error =
            message("xmlui.Submission.submit.UploadResearchDataStep.upload_error");

    protected static final Message T_virus_checker_error =
            message("xmlui.Submission.submit.UploadResearchDataStep.virus_checker_error");
    protected static final Message T_virus_error =
            message("xmlui.Submission.submit.UploadResearchDataStep.virus_error");

    protected static final Message T_description =
            message("xmlui.Submission.submit.UploadResearchDataStep.description");
    protected static final Message T_description_help =
            message("xmlui.Submission.submit.UploadResearchDataStep.description_help");
    protected static final Message T_submit_upload =
            message("xmlui.Submission.submit.UploadResearchDataStep.submit_upload");
    protected static final Message T_head2 =
            message("xmlui.Submission.submit.UploadResearchDataStep.head2");
    protected static final Message T_column0 =
            message("xmlui.Submission.submit.UploadResearchDataStep.column0");
    protected static final Message T_column1 =
            message("xmlui.Submission.submit.UploadResearchDataStep.column1");
    protected static final Message T_column2 =
            message("xmlui.Submission.submit.UploadResearchDataStep.column2");
    protected static final Message T_column3 =
            message("xmlui.Submission.submit.UploadResearchDataStep.column3");
    protected static final Message T_column4 =
            message("xmlui.Submission.submit.UploadResearchDataStep.column4");
    protected static final Message T_column5 =
            message("xmlui.Submission.submit.UploadResearchDataStep.column5");
    protected static final Message T_column6 =
            message("xmlui.Submission.submit.UploadResearchDataStep.column6");
    protected static final Message T_unknown_name =
            message("xmlui.Submission.submit.UploadResearchDataStep.unknown_name");
    protected static final Message T_unknown_format =
            message("xmlui.Submission.submit.UploadResearchDataStep.unknown_format");
    protected static final Message T_supported =
            message("xmlui.Submission.submit.UploadResearchDataStep.supported");
    protected static final Message T_known =
            message("xmlui.Submission.submit.UploadResearchDataStep.known");
    protected static final Message T_unsupported =
            message("xmlui.Submission.submit.UploadResearchDataStep.unsupported");
    protected static final Message T_submit_edit =
            message("xmlui.Submission.submit.UploadResearchDataStep.submit_edit");
    protected static final Message T_checksum =
            message("xmlui.Submission.submit.UploadResearchDataStep.checksum");
    protected static final Message T_submit_remove =
            message("xmlui.Submission.submit.UploadResearchDataStep.submit_remove");
